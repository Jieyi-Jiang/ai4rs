...
class RotatedDINOHead(RotatedDeformableDETRHead):
    ...
    def loss_by_feat(
        ...
        loss_dict = super(RotatedDeformableDETRHead, self).loss_by_feat(
    ...
    def _get_dn_targets_single(self, gt_instances: InstanceData,
        ...
        factor = gt_bboxes.new_tensor([img_w, img_h, img_w,
                                       img_h]).unsqueeze(0)
        gt_bboxes_value = gt_bboxes.tensor
        gt_bboxes_value_xywh = gt_bboxes_value[..., :4]
        gt_bboxes_value_angle = gt_bboxes_value[..., 4:]
        gt_bboxes_normalized_xywh = gt_bboxes_value_xywh / factor

        # gt_bboxes_targets = bbox_xyxy_to_cxcywh(gt_bboxes_normalized)
        bbox_targets[pos_inds, :4] = gt_bboxes_normalized_xywh.repeat([num_groups, 1])
        bbox_targets[pos_inds, 4:] = gt_bboxes_value_angle.repeat([num_groups, 1])
