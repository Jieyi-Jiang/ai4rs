...
# from mmdet.models.dense_heads import RotatedDINOHead
...
class RotatedRTDETRHead(RotatedDINOHead):
    ...
    def split_outputs(all_layers_cls_scores: List[Tensor],
        ...
        assert_no_nan_inf(all_layers_matching_cls_scores)
        assert_no_nan_inf(all_layers_matching_bbox_preds)
        assert_no_nan_inf(all_layers_denoising_cls_scores)
        assert_no_nan_inf(all_layers_denoising_bbox_preds)
    ...
    def _loss_dn_single(self, dn_cls_scores: Tensor, dn_bbox_preds: Tensor,
        ...
        Returns:
            ...
            `loss_iou`.
        """
        assert_no_nan_inf(dn_cls_scores)
        assert_no_nan_inf(dn_bbox_preds)
        # assert_no_nan_inf(batch_gt_instances)
        ...
        bbox_preds_xywh = bbox_preds[..., :4]
        bbox_preds_angle = bbox_preds[..., 4:]
        bbox_targets_xywh = bbox_targets[..., :4]
        bbox_targets_angle = bbox_targets[..., 4:]
        # bboxes = bbox_cxcywh_to_xyxy(bbox_preds) * factors
        bboxes_xywh = bbox_preds_xywh * factors
        bboxes = torch.cat([bboxes_xywh, bbox_preds_angle], dim=-1)
    ...
    def _predict_by_feat_single(self,
        ...
        assert_no_nan_inf(cls_score)
        assert_no_nan_inf(bbox_pred)
