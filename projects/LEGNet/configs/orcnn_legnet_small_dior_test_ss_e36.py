...
custom_imports = dict(imports=['projects.LEGNet.legnet'])
...
model = dict(
    ...
    backbone=dict(
        ...
        fork_feat=True,
        drop_path_rate=0.1,
        init_cfg=dict(type='Pretrained', checkpoint="https://www.modelscope.cn/models/wokaikaixinxin/ai4rs/resolve/"
                                                    "master/LEGNet/LWEGNet_small.pth")),
    neck=dict(
        type='mmdet.FPN',
