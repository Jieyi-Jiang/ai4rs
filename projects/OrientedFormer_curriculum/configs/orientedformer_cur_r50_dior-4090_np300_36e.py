...
model = dict(
    ...
    dn_cfg=dict(  # TODO: Move to model.train_cfg ?
        ...
        dynamic_schedule=[
            ...
            dict(start=23, end=35, ratio=1.0),],
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(_delete_=True, type='AdamW', lr=1e-4, weight_decay=1e-4),
...
#         type='LinearLR', start_factor=1.0/3, by_epoch=False, begin=0,end=1000),
#     dict(
#         type='MultiStepLR',
#         begin=0,
#         end=36,
